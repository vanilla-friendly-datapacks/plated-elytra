...
# Apply armor value.
data merge entity @s {Motion: [0.0d, 0.1d, 0.0d], Item: {tag: {zerotask: {PlatedElytra: 1b}, CustomModelData: 1340002, display: {Name: '{"translate": "item.plated_elytra.gold","color":"yellow","italic": false}'}, AttributeModifiers: [{AttributeName: "generic.armor", Name: "generic.armor", Amount: 2, Operation: 0, Slot: "chest", UUID: [I; 479578499, 390548714, -2098248631, 699752253]}]}}}
